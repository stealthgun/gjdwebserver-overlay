...
pkg_postinst() {
	...
	einfo "# install -Dt \"/usr/lib/modules/5.16.0-pinephone-gentoo-arm64/build/drivers/md\" -m644 drivers/md/*.h"
  	einfo "# install -Dt \"/usr/lib/modules/5.16.0-pinephone-gentoo-arm64/build/net/mac80211\" -m644 net/mac80211/*.h"
  	einfo "# install -Dt \"/usr/lib/modules/5.16.0-pinephone-gentoo-arm64/build/drivers/media/i2c\" -m644 drivers/media/i2c/msp3400-driver.h"
  	einfo "# install -Dt \"/usr/lib/modules/5.16.0-pinephone-gentoo-arm64/build/drivers/media/usb/dvb-usb\" -m644 drivers/media/usb/dvb-usb/*.h"
  	einfo "# install -Dt \"/usr/lib/modules/5.16.0-pinephone-gentoo-arm64/build/drivers/media/dvb-frontends\" -m644 drivers/media/dvb-frontends/*.h"
  	einfo "# install -Dt \"/usr/lib/modules/5.16.0-pinephone-gentoo-arm64/build/drivers/media/tuners\" -m644 drivers/media/tuners/*.h"
}
